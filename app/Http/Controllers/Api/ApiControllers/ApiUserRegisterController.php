...
class ApiUserRegisterController extends ApiBaseController {

	protected $class = 'UserRegister';
	...
	{
		$path = [
					'index' 	=> urlApi().'/register',
					'store' 	=> urlApi().'/register',
					'update' 	=> urlApi().'/register/{key}',
					'destroy' 	=> urlApi().'/register/{key}',
				];
	...
	public function description($method)
	{
		$desc = [
					'index' 	=> '',
					'store' 	=> 'Authenticate when user registers.',
					'update' 	=> '',
					'destroy' 	=> '',
				];
	...
	public function storeModel()
	{
		$input 	= [
			...
			'id_card'		=> ['type' => 'string', 'req' => 'required', 'desc' => 'ID Card'],
			'passcode'		=> ['type' => 'string', 'req' => 'required', 'desc' => 'Passcode 4 digits'],
	...
	public function store(Request $request)
	{
		...
		// Get User.
		$userModel = $this->employeeRepo->getByEmpKeyPasswordAndIdCard(
