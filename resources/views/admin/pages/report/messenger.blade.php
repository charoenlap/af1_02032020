    ...
    <div class="panel">
	    ...
	    <div class="panel-body" style="padding-top: 0">
		    <div class="row">
		    	...
		    	<div class="col-sm-12">
	    			<h5 class="pull-left">Messenger Table [ตารางแสดงงานแมสเซนเจอร์]</h5>
...
<div id="mw-url-get-data" data-url="{{ \URL::route('admin.report_messenger.get_data.post') }}"></div>
<div id="mw-url-adjust-report" data-url="{{ \URL::route('admin.report_messenger.adjust_report.post') }}"></div>
<div id="mw-url-gen-report" data-url="{{ \URL::route('admin.report_messenger.gen_excel.post') }}"></div>